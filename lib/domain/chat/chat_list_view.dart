              ...
              child: FutureBuilder(
                  ...
                  builder:
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      debugPrint(
                          "[Error]:: ChatListView snapshot error : ${snapshot.error}");
...
//전체 제안 거래중 완료 버튼
  ...
  Widget _item(dynamic row, int index) {
    ...
    final String imageUrl = row["B_COVER_IMG"] ??
...
class TempData {
  List<Map<String, dynamic>> rowsSupplies = [
    ...
    },
    {
      "userName": "신승훈",
      "bookName": "블록체인",
      "imageUrl": "assets/images/s2.jpeg",
      "status": "C",
      "time": "1일 전"
    },
    {
      "userName": "신승훈",
      "bookName": "우리는 어떻게 괴물이 되어가",
      "imageUrl": "assets/images/s3.jpeg",
      "status": "I",
      "time": "1일 전"
    },
    {
  ...
  List<Map<String, dynamic>> rowsRentals = [
    {
      "userName": "정인수",
      "bookName": "그냥 하지 말라",
      "imageUrl": "assets/images/i1.jpeg",
      "status": "E",
      "time": "7일 전"
    },
    {
      "userName": "구성연",
      "bookName": "스타트업 경영수업",
      "imageUrl": "assets/images/d1.jpeg",
      "status": "G",
      "time": "9일 전"
    },
    {
      "userName": "현우",
      "bookName": "프레임의 힘",
      "imageUrl": "assets/images/e1.jpeg",
      "status": "F",
      "time": "9일 전"
    },
    {
      "userName": "방현주",
      "bookName": "레버리지",
      "imageUrl": "assets/images/i3.jpeg",
      "status": "G",
      "time": "14일 전"
    },
    {
      "userName": "미네르바",
      "bookName": "코스모스",
      "imageUrl": "assets/images/i4.jpeg",
      "status": "A",
      "time": "14일 전"
    },
    {
